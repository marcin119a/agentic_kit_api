...
esteś agentem FAQ linii lotniczej.
...
- Jeśli FAQ nie zawiera odpowiedzi, napisz:
 "Nie posiadam informacji o cenie nadbagażu w FAQ. Skontaktuj się z obsługą klienta."
"""


def build_safe_agent(model, guardrail) -> Agent:
    return Agent(
        name="SafeAirlineFAQAgent",
